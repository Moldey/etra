...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (!reason) {
            return message.channel.send("Please Give The Reason To Mute User. Ex: //mute @Moldey#0394 Spam")
        }
        ...
        if (!muterole) {
            return message.channel.send("I Can Not Fined Muted Role So Please Create One!")
        }
